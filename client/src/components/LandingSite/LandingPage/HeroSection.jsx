    ...
    <main className="flex flex-col lg:flex-row-reverse justify-center align-center  text-white text-center">
      ...
      <div className="md:pt-[8%]">
        <h1 className="font-bold text-6xl">
          Hostel <span className="text-yellow-500">Management</span> System
        </h1>
        <p className="py-10 text-2xl">
          One Stop Solution For All Of The Hostel&apos;s Needs
        </p>
        <div className="py-20">
          <Link
            to="/auth/login"
            className="bg-red-500 py-3 px-40 hover:bg-blue-700 transition rounded text-2xl"
          >
            Login
          </Link>
