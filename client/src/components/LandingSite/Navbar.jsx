  ...
  return (
    <nav className="flex align-center justify-between p-10 text-white md:px-20">
      ...
      >
        <Link
          to="/about"
          className="md:py-3 md:hover:text-yellow-500 transition-all ease-linear"
        >
          About
        </Link>
        <Link
        ...
        <Link
          to="/auth/login"
          className={`md:bg-red-500 md:hover:bg-red-700 transition md:text-white font-bold md:text-lg md:py-3 md:mb-3 md:px-8 md:rounded ${
